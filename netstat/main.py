...
if __name__ == '__main__':
    ...
    dist_distr_multi = get_distance_distribution_parallel(lcc, directed)
    # dist_distr_single = np.trim_zeros(pol.get_distance_distribution(lcc, directed=directed), 'b')
    # dist_distr = sample_random_pairs(lcc, 100, directed)
    # dist_distr = sample_random_sources(lcc, 100, directed)
    print dist_distr_multi
    # print dist_distr_single
